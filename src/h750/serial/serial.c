...
#if defined(LPUART1_PA10_RX_PA9_TX)
    init_lpuart1_pa10_pa9(ci, baud);
#elif defined(LPUART1_PB7_RX_PB6_TX)
    init_lpuart1_pb7_pb6(ci, baud);
#elif defined(UART4_PA1_RX_PA0_TX)
    init_uart4_pa1_pa0(ci, baud);
#elif defined(UART4_PB8_RX_PB9_TX)
    init_uart4_pb8_pb9(ci, baud);
#elif defined(UART4_PC11_RX_PC10_TX)
    init_uart4_pc11_pc10(ci, baud);
#elif defined(UART4_PD0_RX_PD1_TX)
    init_uart4_pd0_pd1(ci, baud);
#elif defined(UART5_PB12_RX_PB13_TX)
    init_uart5_pb12_pb13(ci, baud);
#elif defined(UART5_PB5_RX_PB6_TX)
    init_uart5_pb5_pb6(ci, baud);
#elif defined(UART5_PD2_RX_PC12_TX)
    init_uart5_pd2_pc12(ci, baud);
#elif defined(UART7_PB3_RX_PB4_TX)
    init_uart7_pb3_pb4(ci, baud);
#elif defined(UART7_PE7_RX_PE8_TX)
    init_uart7_pe7_pe8(ci, baud);
#elif defined(UART7_PA8_RX_PA15_TX)
    init_uart7_pa8_pa15(ci, baud);
#elif defined(UART8_PE0_RX_PE1_TX)
    init_uart8_pe0_pe1(ci, baud);
#elif defined(USART1_PA10_RX_PA9_TX)
    init_usart1_pa10_pa9(ci, baud);
#elif defined(USART1_PB15_RX_PB14_TX)
    init_usart1_pb15_pb14(ci, baud);
#elif defined(USART1_PB7_RX_PB6_TX)
    init_usart1_pb7_pb6(ci, baud);
#elif defined(USART2_PA3_RX_PA2_TX)
    init_usart2_pa3_pa2(ci, baud);
#elif defined(USART2_PD6_RX_PD5_TX)
    init_usart2_pd6_pd5(ci, baud);
#elif defined(USART3_PB11_RX_PB10_TX)
    init_usart3_pb11_pb10(ci, baud);
#elif defined(USART3_PC11_RX_PC10_TX)
    init_usart3_pc11_pc10(ci, baud);
#elif defined(USART3_PD9_RX_PD8_TX)
    init_usart3_pd9_pd8(ci, baud);
#elif defined(USART6_PC7_RX_PC6_TX)
    init_usart6_pc7_pc6(ci, baud);
#endif
}

void serial_write_char(int c){
#if defined(LPUART1_PA10_RX_PA9_TX) || defined(LPUART1_PB7_RX_PB6_TX)
...
int serial_read_char(void){
    ...
    return uart5_read_char();
      ...
      defined(UART7_PE7_RX_PE8_TX) || \
      defined(UART7_PA8_RX_PA15_TX)
    return uart7_read_char();
#elif defined(UART8_PE0_RX_PE1_TX)
    return uart8_read_char();
#elif defined(USART1_PA10_RX_PA9_TX)  || \
      defined(USART1_PB15_RX_PB14_TX) || \
      defined(USART1_PB7_RX_PB6_TX)
    ...
    return usart2_read_char();
      ...
      defined(USART3_PC11_RX_PC10_TX) || \
      defined(USART3_PD9_RX_PD8_TX)
    return usart3_read_char();
#elif defined(USART6_PC7_RX_PC6_TX)
    return usart6_read_char();
#endif
}
