...
#define TIM12_CR1   (volatile uint32_t *)(TIM12 + 0x00) 
#define TIM12_CR2   (volatile uint32_t *)(TIM12 + 0x04) 
#define TIM12_SMCR  (volatile uint32_t *)(TIM12 + 0x08) 
#define TIM12_DIER  (volatile uint32_t *)(TIM12 + 0x0c) 
#define TIM12_SR    (volatile uint32_t *)(TIM12 + 0x10) 
#define TIM12_EGR   (volatile uint32_t *)(TIM12 + 0x14) 
#define TIM12_CCMR1 (volatile uint32_t *)(TIM12 + 0x18) 
#define TIM12_CCER  (volatile uint32_t *)(TIM12 + 0x20) 
#define TIM12_CNT   (volatile uint32_t *)(TIM12 + 0x24) 
#define TIM12_PSC   (volatile uint32_t *)(TIM12 + 0x28) 
#define TIM12_ARR   (volatile uint32_t *)(TIM12 + 0x2c) 
#define TIM12_CCR1  (volatile uint32_t *)(TIM12 + 0x34) 
#define TIM12_CCR2  (volatile uint32_t *)(TIM12 + 0x38) 
#define TIM12_TISEL (volatile uint32_t *)(TIM12 + 0x68) 

#define TIM13_CR1   (volatile uint32_t *)(TIM13 + 0x00) 
#define TIM13_DIER  (volatile uint32_t *)(TIM13 + 0x0c) 
#define TIM13_SR    (volatile uint32_t *)(TIM13 + 0x10) 
#define TIM13_EGR   (volatile uint32_t *)(TIM13 + 0x14) 
#define TIM13_CCMR1 (volatile uint32_t *)(TIM13 + 0x18) 
#define TIM13_CCER  (volatile uint32_t *)(TIM13 + 0x20) 
#define TIM13_CNT   (volatile uint32_t *)(TIM13 + 0x24) 
#define TIM13_PSC   (volatile uint32_t *)(TIM13 + 0x28) 
#define TIM13_ARR   (volatile uint32_t *)(TIM13 + 0x2c) 
#define TIM13_CCR1  (volatile uint32_t *)(TIM13 + 0x34) 
#define TIM13_TISEL (volatile uint32_t *)(TIM13 + 0x68) 
...
#define TIM16_SMCR  (volatile uint32_t *)(TIM16 + 0x08) 
...
#define TIM17_SMCR  (volatile uint32_t *)(TIM17 + 0x08) 
